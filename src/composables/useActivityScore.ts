...
import { TIMING, getLocalDateString, msUntilLocalMidnight } from '../utils/activity'
...
export function useActivityScore() {
  ...
  onMounted(() => {
    tickTimer = setInterval(update, TIMING.activityTickMs)
    scheduleMidnightReset()
  })
  ...
  return { score: monitorStore.score }
}
