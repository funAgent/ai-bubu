...
const messages: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    teamEmpty: '暂无团队数据',
    teamEmptyDesc: '在设置中填写团队名称，开启社交后即可查看',
    teamTotalSteps: '团队总步数',
    teamPeople: '人',
  ...
  en: {
    ...
    settingsAutoStartHint: 'Start AI bubu when you log in',
    ...
    teamEmpty: 'No team data',
    teamEmptyDesc: 'Set a team name in Settings and enable LAN discovery',
    teamTotalSteps: 'Team Total Steps',
    teamPeople: ' members',
